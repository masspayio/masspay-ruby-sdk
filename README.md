...
```shell
gem build masspay_ruby_sdk.gemspec
```

Then either install the gem locally:

```shell
gem install ./masspay_ruby_sdk-1.0.0.gem
```

(for development, run `gem install --dev ./masspay_ruby_sdk-1.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'masspay_ruby_sdk', '~> 1.0.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/masspayio/masspay-ruby-sdk, then add the following in the Gemfile:

    gem 'masspay_ruby_sdk', :git => 'https://github.com/masspayio/masspay-ruby-sdk.git'
