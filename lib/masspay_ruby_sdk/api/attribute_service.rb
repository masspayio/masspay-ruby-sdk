...
module MasspayRubySdk
  class AttributeService
    ...
    def get_all_attrs user_token
      @client.get("attribute/#{user_token}") 
    end
    ...
    def store_attrs user_token, destination_token, currency, body
      @client.post("attribute/#{user_token}/#{destination_token}/#{currency}") do |req|
        req.body = body
      end
    end
    ...
    def get_attrs user_token, destination_token, currency
      @client.get("attribute/#{user_token}/#{destination_token}/#{currency}") 
    end
